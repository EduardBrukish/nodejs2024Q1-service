...
export class Auto1710949653109 implements MigrationInterface {
    name = 'Auto1710949653109'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favorite" ("id" character varying NOT NULL, "artistId" uuid, "albumId" uuid, "trackId" uuid, CONSTRAINT "REL_0b7b9c184c74b5d0ae32796c62" UNIQUE ("artistId"), CONSTRAINT "REL_4d3e1db289b90223ee9aa3835a" UNIQUE ("albumId"), CONSTRAINT "REL_a1aa0ad0d3036ae303984b553d" UNIQUE ("trackId"), CONSTRAINT "PK_495675cec4fb09666704e4f610f" PRIMARY KEY ("id"))`);
