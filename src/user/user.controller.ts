import { Controller, Get, Delete, Param, UsePipes, ParseUUIDPipe, Body, Post, Put, HttpException, HttpStatus, ValidationPipe } from "@nestjs/common";
...
export class UserController {
    ...
    ): User 
  {
    ...
    const updatedUser = this.userService.updateUserPassword(user, updateUserPasswordDto.newPassword);
    return updatedUser;
  }
